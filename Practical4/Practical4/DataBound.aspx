...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [OrderID], [CustomerID], [RequiredDate], [OrderDate] FROM [Orders] WHERE ([CustomerID] = @CustomerID)">
                <SelectParameters>
